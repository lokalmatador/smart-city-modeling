...
public class SmartCityParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SmartCityGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSensorAccess().getCyclicActionsAssignment_7(), "rule__Sensor__CyclicActionsAssignment_7");
			builder.put(grammarAccess.getSensorAccess().getTriggeredActionsAssignment_8(), "rule__Sensor__TriggeredActionsAssignment_8");
			...
			builder.put(grammarAccess.getControllerAccess().getPriorityAssignment_6(), "rule__Controller__PriorityAssignment_6");
			builder.put(grammarAccess.getControllerAccess().getCyclicActionsAssignment_7(), "rule__Controller__CyclicActionsAssignment_7");
			builder.put(grammarAccess.getControllerAccess().getTriggeredActionsAssignment_8(), "rule__Controller__TriggeredActionsAssignment_8");
