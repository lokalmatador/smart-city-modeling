...
public class SmartCityParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SmartCityGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNodeAccess().getFreqValueAssignment_7(), "rule__Node__FreqValueAssignment_7");
			builder.put(grammarAccess.getNodeAccess().getFreqUnitAssignment_8(), "rule__Node__FreqUnitAssignment_8");
			builder.put(grammarAccess.getNodeAccess().getLinksAssignment_9(), "rule__Node__LinksAssignment_9");
